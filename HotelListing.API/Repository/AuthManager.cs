    ...
    public class AuthManager : IAuthManager
    {
        ...
        public async Task<AuthResponseDto> VerifyRefreshToken(AuthResponseDto request)
        {
            ...
            if (_user == null || _user.Id != request.UserId)
            {
                ...
                throw new Exception("❌ User is NULL while creating refresh token!");

            }   

            var isValidRefreshToken = await _userManager.VerifyUserTokenAsync(_user, _loginProvider, _refreshTokenName, request.RefreshToken);
